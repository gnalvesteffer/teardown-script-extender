...
// Below is deprecated, updated to just hooking and handling camera movement @ Noclip.cpp
// UpdateCamera + 610    F3 0F 11 43 7C                                movss   dword ptr[rbx + 7Ch], xmm0; // Set X Camera pos
// UpdateCamera + 615    F3 0F 11 8B 84 00 00 00                       movss   dword ptr[rbx + 84h], xmm1; // Set Z camera pos
// UpdateCamera + 61D    F3 0F 10 93 80 00 00 00                       movss   dword ptr[rbx + 80h], xmm2; // Set Y camera pos
